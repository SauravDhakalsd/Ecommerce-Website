...
import {BACKEND_URL} from '../constants/settingConstant'
...
export const getProduct =
  ...
  async (dispatch) => {
    try {
      ...
      let link = `${BACKEND_URL}/api/v1/products?page=${currentPage}&price[gte]=${price[0]}&price[lte]=${price[1]}&ratings[gte]=${ratings}`;
      // keyword=${keyword}
      if (category) {
...
export const removeReviews = (reviewId, productId) => async (dispatch) => {
  try {
